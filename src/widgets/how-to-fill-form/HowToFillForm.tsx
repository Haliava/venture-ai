...
export const HowToFillForm = () => {
  ...
  return (
    <div onClick={handleClickSuggestion} className="grid items-center sm:mx-2 md:mx-0 xs:grid-cols-1 sm:grid-cols-[2fr_1fr] lg:grid-cols-[11fr_4fr] justify-between items-center lg:items-start rounded-2xl px-2.5 lg:px-[3vmin] py-3.5 m-auto gap-10 bg-help">
